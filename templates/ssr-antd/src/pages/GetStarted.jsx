...
const steps = [
  { title: "Intro", component: StepIntro },
  { title: "SSR", component: StepSSR },
  { title: "State management & API", component: StepStateAndAPI },
  { title: "Routing", component: StepRouting },
  { title: "UI", component: StepUI },
  { title: "All done!", component: StepDone },
];
    ...
    <>
      <>
        ...
        <div style={{ textAlign: "justify", fontSize: 20, lineHeight: 1.7 }}>
          ...
          <span style={{ fontWeight: 600 }}>Ant Design (AntD)</span> library for
          styling its components, providing a consistent and aesthetically
          pleasing user interface. Ant Design is a popular React component
          library, offering a set of pre-designed, customizable components that
          adhere to modern design standards.
          <br />
          To learn more about AntD{" "}
          <a target="_antd" href="https://ant.design/components/overview/">
            click here
          </a>
          .
          <br />
  ...
  return (
    ...
    >
      <Button
        ...
        onClick={handleBack}
        style={{ display: activeStep === 0 ? "none" : "", marginRight: 10 }}
      >
        Back
      </Button>
      <div style={{ flex: "1 1 auto" }} />
...
export default function GetStarted() {
  ...
  return (
    <div style={{ marginTop: 30 }}>
      <div sx={{ width: "100%" }}>
        <Steps progressDot current={activeStep} items={steps} />
